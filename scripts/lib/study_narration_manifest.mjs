...
export const STUDY_AUDIO_ROOT = STUDY_PUBLIC_AUDIO_ROOT;
...
export function buildStudyNarrationTargetRelativePath(lessonId, cardId, extension = ".mp3") {
  return formatRelativePath("frontend", "public", "audio", "study", lessonId, `${cardId}${extension}`);
}
...
export async function writeStudyNarrationManifestFiles(manifest) {
  ...
  await fs.mkdir(STUDY_AUDIO_ROOT, { recursive: true });
