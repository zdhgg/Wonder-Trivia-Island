...
function buildQuestion(
  { subject, grade, semester = "通用", knowledgeTag = "", type, content, correctText, distractors, explanation, difficulty },
  orderIndex
) {
...
function createChallengeConfigs(grade, subject, knowledgeTag, rawConfigs, semester = "通用") {
  return rawConfigs.map(([type, content, correctText, distractors, explanation, difficulty = 3]) => ({
    subject,
    grade,
    semester,
    knowledgeTag,
...
function createConfigList(rawConfigs) {
  return rawConfigs.map(([grade, type, content, correctText, distractors, explanation, difficulty]) => ({
    grade,
    type,
    content,
    correctText,
...
const mathExtraQuestionConfigs = createConfigList([
  ...
  ["三年级", "长方形周长", "一个长方形长 7 厘米，宽 3 厘米，它的周长是多少厘米？", "20厘米", ["10厘米", "17厘米", "21厘米"], "长方形周长是 (7 + 3) × 2 = 20 厘米。", 2],
...
const gradeOneUpperStageOneChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "看图起步", [
    ["数一数", "桌上原来有2本书，又放上1本，现在桌上一共有几本书？", "3本", ["2本", "4本", "5本"], "2本再加1本，一共是3本。", 1],
    ["大小比较", "在2、7、5里面，最小的数是哪一个？", "2", ["5", "7", "一样大"], "2比5和7都小。", 1],
    ["位置", "小兔在小狗左边，小狗在小兔的哪边？", "右边", ["左边", "前面", "后面"], "左右位置是相对的，小狗在小兔右边。", 1]
  ]),
  ...createGradeOneChallengeConfigs("语文", "看图起步", [
    ["识字应用", "表示“耳朵”的汉字是哪一个？", "耳", ["目", "口", "手"], "“耳”表示耳朵。", 1],
    ["课文理解", "《升国旗》里，我们的国旗叫什么？", "五星红旗", ["彩旗", "队旗", "小红旗"], "课文里说五星红旗是我们的国旗。", 1],
    ["词语搭配", "下面哪个词最适合填“红红的（ ）”？", "苹果", ["天空", "月亮", "河水"], "“红红的苹果”是常见搭配。", 1]
  ])
];

const gradeOneUpperStageTwoChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "顺序跟答", [
    ["数的顺序", "按顺序填数：6、7、8、（ ）", "9", ["5", "10", "11"], "按顺序数，8后面是9。", 1],
    ["数的顺序", "从10往后数，第3个数是几？", "13", ["11", "12", "14"], "10后面依次是11、12、13。", 1],
    ["几个和第几个", "5个小朋友排队，小兰排第2，她前面有几人？", "1人", ["2人", "3人", "4人"], "排第2说明前面有1人。", 1],
    ["位置", "小明站在队伍第4个位置，他前面有几人？", "3人", ["2人", "4人", "5人"], "第4个位置前面有3人。", 1],
    ["找规律", "按顺序摆：红、黄、红、黄、红、（ ）", "黄", ["红", "蓝", "绿"], "颜色按红、黄重复出现，所以后面是黄。", 1]
  ]),
  ...createGradeOneChallengeConfigs("语文", "顺序跟答", [
    ["声母认读", "按顺序读声母：b、p、m、f、（ ）", "d", ["a", "o", "i"], "声母顺序里，f后面是d。", 1],
    ["韵母认读", "按顺序读单韵母：a、o、e、（ ）", "i", ["u", "b", "m"], "单韵母顺序里，e后面是i。", 1],
    ["课文理解", "《影子》里，前一句是“影子在前”，下一句是什么？", "影子在后", ["影子在左", "影子在上", "影子不见了"], "课文里写“影子在前，影子在后”。", 1],
    ["标点符号", "一句话还没说完，中间轻轻停一下，常用哪个标点？", "逗号", ["句号", "问号", "感叹号"], "句子中间短暂停顿，常用逗号。", 1],
    ["量词运用", "给“小鸟”选量词，一（ ）小鸟最合适？", "只", ["条", "本", "朵"], "小鸟通常用“只”来搭配。", 1]
  ])
];

const gradeOneUpperStageThreeChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "数量找友", [
    ["数的组成", "14和哪个数合起来能凑成20？", "6", ["4", "5", "7"], "14再加6就是20。", 2],
    ["数的分解", "把15分成10和另一个数，另一个数是几？", "5", ["4", "6", "10"], "15可以分成10和5。", 2],
    ["数位认识", "20是由几个十组成的？", "2个十", ["1个十", "2个一", "20个一"], "20由2个十组成。", 2],
    ["数位认识", "17里面，个位上的数是几？", "7", ["1", "10", "17"], "17的个位上是7。", 2],
    ["数的组成", "1个十和8个一组成几？", "18", ["10", "17", "28"], "1个十和8个一组成18。", 2]
  ]),
  ...createGradeOneChallengeConfigs("语文", "数量找友", [
    ["书写规范", "写字时，两只脚怎样放更合适？", "平放地面", ["翘在椅子上", "踩在桌脚上", "一前一后乱摆"], "写字时坐姿要端正，双脚平放更合适。", 2],
    ["量词运用", "下面哪个量词最适合“一（ ）星星”？", "颗", ["条", "本", "把"], "星星通常用“颗”来搭配。", 2],
    ["笔画数", "汉字“田”一共有几画？", "5画", ["4画", "6画", "7画"], "“田”共有5画。", 2],
    ["量词运用", "下面哪个量词最适合“一（ ）豆子”？", "粒", ["条", "把", "本"], "豆子通常用“粒”来搭配。", 2],
    ["词语理解", "“一群小鸟”里的“群”最能说明什么？", "数量很多", ["只有一只", "没有数量", "只有两只"], "“群”通常表示数量比较多。", 2]
  ])
];

const gradeOneUpperStageFourChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "短句抓点", [
    ["解决问题", "妈妈买来13个橘子，上午吃了4个，下午又吃了3个，还剩多少个？", "6个", ["5个", "7个", "8个"], "13 - 4 - 3 = 6，所以还剩6个。", 2],
    ["解决问题", "小亮做了11道题，对了8道，错了几道？", "3道", ["2道", "4道", "5道"], "11 - 8 = 3，所以错了3道。", 2],
    ["解决问题", "操场上有7个男生和5个女生，一共有多少人？", "12人", ["10人", "11人", "13人"], "7 + 5 = 12，所以一共有12人。", 2],
    ["数位认识", "19里面十位上的数是几？", "1", ["9", "10", "19"], "19的十位上是1。", 2],
    ["数的组成", "12再添上8，一共是多少？", "20", ["18", "19", "21"], "12加8等于20。", 2],
    ["找规律", "按规律填数：5、10、15、20、（ ）", "25", ["22", "24", "30"], "这些数每次增加5，所以后面是25。", 2],
    ["解决问题", "文具盒里有14支铅笔，借给同学5支，还剩多少支？", "9支", ["8支", "10支", "11支"], "14 - 5 = 9，所以还剩9支。", 2],
    ["解决问题", "图书角有16本故事书，拿走7本，还剩多少本？", "9本", ["8本", "10本", "11本"], "16 - 7 = 9，所以还剩9本。", 2],
    ["数位认识", "17里面个位上的数是几？", "7", ["1", "10", "17"], "17的个位上是7。", 2],
    ["找规律", "按规律填数：2、6、10、14、（ ）", "18", ["16", "17", "20"], "这些数每次增加4，所以后面是18。", 2]
  ]),
  ...createGradeOneChallengeConfigs("语文", "短句抓点", [
    ["口语交际", "别人帮你捡起橡皮，你更合适说什么？", "谢谢你", ["快点走开", "这本来就是你的", "我不要了"], "别人帮助了你，要礼貌地说谢谢。", 2],
    ["标点符号", "“今天下雨了（ ）” 句末最合适填什么标点？", "句号", ["问号", "感叹号", "顿号"], "陈述一件事情，句末通常用句号。", 2],
    ["课文理解", "《青蛙写诗》里，水泡泡帮忙当什么标点？", "小句号", ["小逗号", "小问号", "小书名号"], "课文里水泡泡说自己可以当个小句号。", 2],
    ["课文理解", "《小小的船》里，“我”坐在哪里？", "小小的船里", ["大海里", "山顶上", "田野里"], "课文里写“我在小小的船里坐”。", 2],
    ["词语搭配", "下面哪个词最适合填“白白的（ ）”？", "云朵", ["苹果", "草地", "太阳"], "“白白的云朵”是合适搭配。", 2],
    ["量词运用", "下面哪个量词最适合“一（ ）白云”？", "朵", ["条", "把", "本"], "白云通常用“朵”来搭配。", 2],
    ["口语交际", "妈妈递给你水果时，你更合适说什么？", "谢谢妈妈", ["我不要", "快点拿来", "你走开"], "接受别人帮助或关心时，要礼貌表达感谢。", 2],
    ["标点符号", "“快来和我一起玩（ ）” 句末更适合填什么标点？", "感叹号", ["句号", "问号", "逗号"], "表示招呼、呼唤时，句末常用感叹号。", 2],
    ["课文理解", "《比尾巴》里，谁的尾巴弯？", "猴子", ["兔子", "鸭子", "孔雀"], "课文里说猴子的尾巴弯。", 2],
    ["词语搭配", "下面哪个词最适合填“闪闪的（ ）”？", "星星", ["书包", "尺子", "小路"], "“闪闪的星星”是常见搭配。", 2]
  ])
];

const gradeOneUpperStageFiveChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "规律连答", [
    ["找规律", "按规律填数：2、5、8、11、（ ）", "14", ["12", "13", "15"], "这些数每次增加3，所以11后面是14。"],
    ["找规律", "按规律填数：19、17、15、（ ）", "13", ["11", "12", "14"], "这些数每次减少2，所以15后面是13。"],
    ["找规律", "按规律填数：3、6、9、（ ）、15", "12", ["10", "11", "13"], "这些数每次增加3，所以9后面是12。"],
    ["找规律", "按规律填数：1、4、7、10、（ ）", "13", ["12", "14", "15"], "这些数每次增加3，所以10后面是13。"],
    ["找规律", "按规律填图：○、△、○、△、○、（ ）", "△", ["○", "□", "☆"], "图形按○、△重复出现，所以后面是△。"],
    ["找规律", "按规律填图：□、□、○、□、□、○、（ ）", "□", ["○", "△", "☆"], "图形按“□、□、○”重复出现，下一个是□。"],
    ["找规律", "按大小规律：1个★、2个★、3个★、（ ）", "4个★", ["2个★", "3个★", "5个★"], "星星个数每次多1，所以后面是4个★。"],
    ["找规律", "按规律填数：4、8、12、（ ）", "16", ["14", "15", "18"], "这些数每次增加4，所以12后面是16。"],
    ["找规律", "按规律填数：20、18、16、14、（ ）", "12", ["10", "11", "13"], "这些数每次减少2，所以后面是12。"],
    ["找规律", "按规律填数：6、9、12、15、（ ）", "18", ["16", "17", "19"], "这些数每次增加3，所以后面是18。"]
  ]),
  ...createGradeOneChallengeConfigs("语文", "规律连答", [
    ["词语形式", "下面哪个词和“高高兴兴”一样，都是 AABB 式？", "干干净净", ["飞来飞去", "雪白雪白", "红红的"], "“干干净净”也是前后两个字各重复一次的 AABB 式词语。"],
    ["词语形式", "下面哪个词和“跑来跑去”是同一类？", "飞来飞去", ["高高兴兴", "又大又圆", "雪白雪白"], "“飞来飞去”也是“来去式”词语。"],
    ["课文理解", "《四季》里，草芽尖尖是春天，荷叶圆圆是夏天，谷穗弯弯是（ ）", "秋天", ["春天", "夏天", "冬天"], "课文里“谷穗弯弯”对应秋天。"],
    ["课文理解", "《雪地里的小画家》里，小鸡画竹叶，小狗画梅花，小鸭画（ ）", "枫叶", ["竹叶", "月牙", "荷叶"], "课文里“小鸭画枫叶”。"],
    ["词语形式", "下面哪个词和“干干净净”是同一类？", "明明白白", ["飞来飞去", "红红的", "又香又甜"], "“明明白白”也是 AABB 式词语。"],
    ["词语形式", "下面哪个词和“走来走去”是同一类？", "看来看去", ["整整齐齐", "雪白雪白", "又细又长"], "“看来看去”也是“来去式”词语。"],
    ["课文理解", "《大小多少》里，“一个大，一个小”说的是哪一组？", "一头黄牛一只猫", ["一群鸭子一只鸟", "一朵花一棵树", "一把伞一本书"], "课文里写“一头黄牛一只猫”。"],
    ["课文理解", "课文《小小的船》把弯弯的月儿比作什么？", "小小的船", ["圆圆的球", "长长的小路", "高高的山"], "课文把弯弯的月儿比作小小的船。"],
    ["词语形式", "下面哪个词和“又高又大”是同一类？", "又香又甜", ["干干净净", "飞来飞去", "明明白白"], "“又香又甜”和“又高又大”都是“又A又B”式词语。"],
    ["课文顺序", "按四季顺序排，春天后面是什么季节？", "夏天", ["秋天", "冬天", "还是春天"], "四季按春、夏、秋、冬排列。"]
  ])
];

const gradeOneUpperStageSixChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "限时稳步", [
    ["20以内不进位加法", "11 + 5 = ?", "16", ["15", "17", "18"], "11加5等于16。"],
    ["20以内不退位减法", "18 - 5 = ?", "13", ["12", "14", "15"], "18减5等于13。"],
    ["20以内不进位加法", "13 + 2 = ?", "15", ["14", "16", "17"], "13加2等于15。"],
    ["20以内不退位减法", "17 - 2 = ?", "15", ["14", "16", "13"], "17减2等于15。"],
    ["数的组成", "16是1个十和几个一？", "6个一", ["5个一", "7个一", "16个一"], "16由1个十和6个一组成。"],
    ["数位认识", "13里面的“1”表示什么？", "1个十", ["1个一", "3个十", "13个一"], "13里的1在十位上，表示1个十。"],
    ["认识钟表", "分针指着12，时针指着7，现在是几时？", "7时", ["6时", "8时", "12时"], "分针指12表示整时，时针指7就是7时。"],
    ["大小比较", "下面哪个算式的结果最大？", "9 + 8", ["17 - 1", "12 + 3", "18 - 4"], "9 + 8 = 17，比其他三个结果都大。"]
  ]),
  ...createGradeOneChallengeConfigs("语文", "限时稳步", [
    ["整体认读音节", "下面哪一个音节要整体认读？", "yu", ["nu", "le", "he"], "yu是整体认读音节。"],
    ["拼音规则", "“x”和“ü”组成音节时，应该写成哪一个？", "xu", ["xü", "xiu", "xua"], "x和ü组成音节时，ü上两点省写成xu。"],
    ["标点符号", "“多漂亮啊（ ）” 句末最合适填什么标点？", "感叹号", ["句号", "问号", "顿号"], "表示赞叹的句子，句末常用感叹号。"],
    ["量词运用", "下面哪个量词最适合“一（ ）雨伞”？", "把", ["条", "只", "本"], "雨伞通常用“把”来搭配。"],
    ["拼音规则", "“q”和“ü”组成音节时，正确写法是哪一个？", "qu", ["qü", "qiu", "qia"], "q和ü组成音节时，ü上两点省写成qu。"],
    ["量词运用", "下面哪个量词最适合“一（ ）帽子”？", "顶", ["条", "本", "朵"], "帽子通常用“顶”来搭配。"],
    ["整体认读音节", "下面哪一个音节也要整体认读？", "shi", ["sa", "ne", "lu"], "shi是整体认读音节。"],
    ["量词运用", "下面哪个量词最适合“一（ ）桌子”？", "张", ["条", "本", "只"], "桌子通常用“张”来搭配。"]
  ])
];

const gradeOneUpperStageSevenChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "启蒙冲线", [
    ["解决问题", "篮子里原来有12个苹果，吃掉2个，又放进3个，现在有多少个？", "13个", ["11个", "12个", "14个"], "12 - 2 + 3 = 13，所以现在有13个苹果。"],
    ["几个和第几个", "排队时，小明前面有3人，后面有2人，这一排一共有多少人？", "6人", ["5人", "7人", "8人"], "前面3人、后面2人，再加上小明自己，一共6人。"],
    ["数位认识", "18里面的“8”表示什么？", "8个一", ["8个十", "1个十", "18个一"], "18里的8在个位上，表示8个一。"],
    ["找规律", "按规律填数：4、7、10、（ ）", "13", ["11", "12", "14"], "这些数每次增加3，所以10后面是13。"],
    ["认识钟表", "分针指着12，时针指着9，现在是几时？", "9时", ["8时", "10时", "12时"], "分针指12表示整时，时针指9就是9时。"],
    ["位置", "小猫在桌子下面，小球在桌子上面。谁在上面？", "小球", ["小猫", "桌子", "都不对"], "题目里说小球在桌子上面。"],
    ["数的顺序", "15前面的一个数是几？", "14", ["13", "16", "17"], "按顺序数，15前面是14。"],
    ["数的组成", "19可以分成1个十和几个一？", "9个一", ["8个一", "10个一", "19个一"], "19由1个十和9个一组成。"],
    ["解决问题", "小朋友做纸花，上午做了8朵，下午又做了7朵，一共做了多少朵？", "15朵", ["14朵", "16朵", "17朵"], "8 + 7 = 15，所以一共做了15朵。"],
    ["几个和第几个", "一排有8人，小冬排第5，他后面有几人？", "3人", ["2人", "4人", "5人"], "一共8人，排第5，后面还有3人。"]
  ]),
  ...createGradeOneChallengeConfigs("语文", "启蒙冲线", [
    ["课文理解", "《四季》里，雪人大肚子一挺，说“我就是（ ）”。", "冬天", ["春天", "夏天", "秋天"], "课文里雪人说“我就是冬天”。"],
    ["整体认读音节", "下面哪个音节属于整体认读音节？", "ri", ["ran", "re", "ru"], "ri要整体认读。"],
    ["标点符号", "“你今天开心吗（ ）” 句末最合适填什么标点？", "问号", ["句号", "感叹号", "逗号"], "表示提问的句子，句末常用问号。"],
    ["词语形式", "下面哪个词和“游来游去”是同一类？", "跳来跳去", ["高高兴兴", "又大又圆", "雪白雪白"], "“跳来跳去”也是“来去式”词语。"],
    ["课文理解", "《画》这首诗里，“近听水”怎么样？", "无声", ["很响", "很深", "很急"], "诗句是“近听水无声”。"],
    ["整体认读音节", "下面哪个音节也要整体认读？", "zhi", ["za", "de", "he"], "zhi是整体认读音节。"],
    ["标点符号", "“太好了，我们出发吧（ ）” 句末更适合填什么标点？", "感叹号", ["句号", "问号", "逗号"], "表达高兴、激动时，句末常用感叹号。"],
    ["词语形式", "下面哪个词和“跑来跑去”属于同一类词语？", "想来想去", ["干干净净", "明明白白", "又大又圆"], "“想来想去”也是“来去式”词语。"],
    ["课文理解", "《雪地里的小画家》里，小马画了什么？", "月牙", ["竹叶", "枫叶", "梅花"], "课文里写“小马画月牙”。"],
    ["口语交际", "同学把橡皮借给你以后，你更合适说什么？", "谢谢你，我会及时还你。", ["快点拿来", "这本来就该给我", "你别说话"], "借用别人的东西后，要礼貌感谢。"]
  ])
];

const gradeOneLowerStageOneChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "独立看题", [
    ["数的顺序", "按顺序数，57后面的一个数是几？", "58", ["56", "59", "67"], "按顺序数，57后面是58。", 1],
    ["100以内数", "70里面有几个十？", "7个十", ["6个十", "70个十", "7个一"], "70由7个十组成。", 1],
    ["分类整理", "4、16、9里，哪个是两位数？", "16", ["4", "9", "都不是"], "16是两位数。", 1]
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "独立看题", [
    ["多音字辨音", "“一只小羊”里的“只”应该读什么？", "zhī", ["zhǐ", "zī", "zhē"], "作量词时，“只”读 zhī。", 1],
    ["音序查字", "查“树”字时，先找哪个大写字母？", "S", ["Sh", "U", "T"], "“树”的音序是 S。", 1],
    ["音节认读", "“笑”字的音节是什么？", "xiào", ["xào", "xiāo", "xǎo"], "“笑”读 xiào。", 1]
  ], "下册")
];

const gradeOneLowerStageTwoChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "条件配对", [
    ["数的顺序", "按顺序数，70前面的一个数是几？", "69", ["68", "71", "79"], "按顺序数，70前面是69。", 1],
    ["100以内数", "关于32和41，哪种说法是对的？", "32 < 41", ["32 > 41", "32 = 41", "41 < 32"], "32小于41。", 1],
    ["人民币", "2元5角一共是多少角？", "25角", ["7角", "52角", "205角"], "2元是20角，再加5角是25角。", 1],
    ["分类整理", "7、15、9里面，哪个是两位数？", "15", ["7", "9", "都不是"], "15是两位数。", 1],
    ["人民币", "1张1元和几张2角一样多？", "5张", ["2张", "4张", "10张"], "1元等于10角，10角能换5张2角。", 1]
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "条件配对", [
    ["姓氏识字", "“口天”合起来表示哪个姓？", "吴", ["李", "张", "胡"], "“口天吴”说的就是吴姓。", 1],
    ["姓氏识字", "“双人徐”里的后一个字是哪一个？", "徐", ["许", "胡", "吴"], "“双人徐”说的就是徐姓。", 1],
    ["量词运用", "给“桥”选量词，一（ ）桥最合适？", "座", ["只", "条", "把"], "桥通常用“座”来搭配。", 1],
    ["动词搭配", "给“故事”选动词，最合适的是哪一个？", "讲", ["洗", "跳", "住"], "我们常说“讲故事”。", 1],
    ["近义词", "“爱护”更像下面哪个词？", "保护", ["离开", "破坏", "忘记"], "“爱护”和“保护”意思相近。", 1]
  ], "下册")
];

const gradeOneLowerStageThreeChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "顺序推想", [
    ["想加算减", "算14减9时，可以先想9加几等于14？", "5", ["4", "6", "7"], "因为9 + 5 = 14，所以14 - 9 = 5。", 2],
    ["人民币", "56角是多少？", "5元6角", ["56元", "6元5角", "5角6分"], "56角就是5元6角。", 2],
    ["认识钟表", "分针指着6，时针在8和9之间，这时是几时半？", "8时半", ["8时", "9时", "9时半"], "分针指向6表示半时。", 2],
    ["数位认识", "56里面的“5”表示什么？", "5个十", ["5个一", "6个十", "56个一"], "56里的5在十位上，表示5个十。", 2],
    ["组数比较", "用3、6、9组成不同的两位数，最大的是多少？", "96", ["93", "69", "63"], "十位放最大的9，个位放6，组成96。", 2]
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "顺序推想", [
    ["音序排序", "“白、王、刘”按音序排，最前面是谁？", "白", ["王", "刘", "一样前"], "白的音序是 B，排在最前面。", 2],
    ["多音字辨音", "“快乐”的“乐”应该读什么？", "lè", ["yuè", "yào", "luò"], "表示高兴时，“乐”读 lè。", 2],
    ["连词成句", "把词语排成通顺句子，哪一句更合适？", "小鸟在树上快乐地唱歌。", ["快乐地小鸟在树上唱歌。", "在树上小鸟唱歌快乐地。", "唱歌小鸟快乐地在树上。"], "按正常语序表达才通顺。", 2],
    ["课文理解", "在《古对今》里，和“春暖”相对的是哪个词？", "秋凉", ["严寒", "酷暑", "晨风"], "课文中有“春暖对秋凉”。", 2],
    ["传统文化", "《人之初》开头告诉我们，人一开始怎样？", "性本善", ["性本恶", "要贪玩", "不读书"], "《人之初》开头是“人之初，性本善”。", 2]
  ], "下册")
];

const gradeOneLowerStageFourChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "比较判断", [
    ["大小比较", "45和54相比，哪个数更大？", "54", ["45", "一样大", "不能比较"], "54比45大。", 2],
    ["数的顺序", "按顺序数，78前面的一个数是几？", "77", ["76", "79", "88"], "按顺序数，78前面是77。", 2],
    ["人民币", "7元和65角相比，哪个更多？", "7元", ["65角", "一样多", "没法比较"], "7元等于70角，比65角多。", 2],
    ["人民币", "45分和5角相比，哪个更多？", "5角", ["45分", "一样多", "都不对"], "5角等于50分，比45分多。", 2],
    ["数位认识", "64里面的“4”在什么位上？", "个位", ["十位", "百位", "千位"], "64里的4在个位上。", 2],
    ["数的分解", "63可以写成什么？", "60 + 3", ["6 + 3", "30 + 6", "60 + 30"], "63由6个十和3个一组成。", 2],
    ["组数比较", "用2、4、8组成不同的两位数，最大的是多少？", "84", ["82", "48", "42"], "十位放8，个位放4，最大是84。", 2],
    ["平面图形", "正方形和长方形相比，谁四条边都一样长？", "正方形", ["长方形", "一样长", "都不对"], "只有正方形四条边都一样长。", 2],
    ["解决问题", "故事书有36本，科技书有29本，哪种书更多？", "故事书", ["科技书", "一样多", "没法比"], "36比29大，所以故事书更多。", 2],
    ["想加算减", "算17减8时，可以先想8加几等于17？", "9", ["8", "10", "7"], "因为8 + 9 = 17，所以17 - 8 = 9。", 2]
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "比较判断", [
    ["反义词", "和“前”意思相反的是哪个词？", "后", ["左", "高", "远"], "“前”和“后”是一对反义词。", 2],
    ["反义词", "和“去”相对的动作是哪个？", "来", ["上", "进", "跑"], "“来”和“去”相对。", 2],
    ["近义词", "“开心”更接近下面哪个词？", "高兴", ["害怕", "难过", "着急"], "“开心”和“高兴”意思相近。", 2],
    ["词语搭配", "下面哪一组词语搭配更自然？", "碧绿碧绿的荷叶", ["碧绿碧绿的太阳", "碧绿碧绿的棉花", "碧绿碧绿的月亮"], "“碧绿碧绿的荷叶”搭配自然。", 2],
    ["标点符号", "“今天真热（ ）” 句末最合适填什么标点？", "感叹号", ["句号", "问号", "逗号"], "表示强烈感受时，句末常用感叹号。", 2],
    ["标点符号", "“你写完作业了吗（ ）” 句末最合适填什么标点？", "问号", ["句号", "感叹号", "逗号"], "表示提问时，句末常用问号。", 2],
    ["课文理解", "在《小青蛙》一课里，小青蛙主要保护什么？", "禾苗", ["花朵", "书本", "石头"], "课文写小青蛙保护禾苗。", 2],
    ["课文理解", "《动物儿歌》里，在花间捉迷藏的是谁？", "蝴蝶", ["蜻蜓", "蚂蚁", "蝌蚪"], "课文里有“蝴蝶花间捉迷藏”。", 2],
    ["连词成句", "读一读，哪一句语序最通顺？", "我们在教室里认真地读书。", ["认真地我们教室里在读书。", "读书教室里认真地我们在。", "教室里读书我们认真地在。"], "按正常语序表达才通顺。", 2],
    ["动词搭配", "给“电话”选动作，最合适的是哪一个？", "打", ["吃", "喝", "开"], "我们常说“打电话”。", 2]
  ], "下册")
];

const gradeOneLowerStageFiveChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "口算稳住", [
    ...createComputeTuples("20以内退位减法", "-", [[18, 7], [17, 6], [15, 8], [12, 7], [14, 9]], 3),
    ...createComputeTuples("100以内口算", "+", [[21, 8], [43, 5], [57, 2], [64, 3]], 3),
    ...createComputeTuples("100以内口算", "-", [[63, 2]], 3)
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "口算稳住", [
    ["多音字辨音", "在“音乐课”这个词里，“乐”字读什么？", "yuè", ["lè", "yào", "luò"], "“音乐”的“乐”读 yuè。", 3],
    ["多音字辨音", "“只好回家”里的“只”应该读什么？", "zhǐ", ["zhī", "zī", "zhè"], "表示“只得”时，“只”读 zhǐ。", 3],
    ["音序排序", "“陈、白、王、徐”按音序排，最前面是谁？", "白", ["陈", "王", "徐"], "白的音序是 B，排在最前面。", 3],
    ["连词成句", "哪一句把“我、妈妈、公园、散步”说通顺了？", "我和妈妈一起去公园散步。", ["我一起和妈妈去公园散步。", "公园散步我和妈妈一起去。", "妈妈去我和一起公园散步。"], "按正常语序表达才通顺。", 3],
    ["句子理解", "“文具用完要送回家”主要想告诉我们什么？", "要及时收好文具", ["要把文具送给别人", "文具不用了就扔掉", "只要好看就行"], "这句话主要提醒我们要爱护并收好文具。", 3],
    ["课文理解", "《一分钟》里，元元迟到和哪件事最有关系？", "多睡了一分钟", ["书包太重", "跑得太快", "天气太冷"], "课文通过元元说明一分钟也很重要。", 3],
    ["传统文化", "《端午粽》一课里，端午节家里常吃什么？", "粽子", ["月饼", "汤圆", "饺子"], "端午节有吃粽子的习俗。", 3],
    ["字谜识字", "那个“左边绿，右边红，左右相遇起凉风”的字谜，谜底是什么？", "秋", ["春", "林", "明"], "这个字谜的谜底是“秋”。", 3],
    ["词语搭配", "下面哪个短语搭配更自然？", "雪白雪白的棉花", ["雪白雪白的太阳", "雪白雪白的河水", "雪白雪白的草地"], "“雪白雪白的棉花”搭配更自然。", 3],
    ["反义词", "和“高兴”意思相反的是哪个词？", "难过", ["开心", "喜欢", "明亮"], "“高兴”和“难过”意思相反。", 3]
  ], "下册")
];

const gradeOneLowerStageSixChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "限时提速", [
    ...createComputeTuples("100以内口算", "+", [[26, 7], [34, 8], [51, 9], [72, 6]], 3),
    ...createComputeTuples("100以内口算", "-", [[82, 6], [95, 7], [73, 8]], 3),
    ...createComputeTuples("两位数加减两位数", "+", [[24, 31]], 3)
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "限时提速", [
    ["音序排序", "“李、白、陈、吴”按音序排，最后一个是谁？", "吴", ["李", "白", "陈"], "吴的音序是 W，排在最后面。", 3],
    ["多音字辨音", "“得先写作业”里的“得”应该读什么？", "děi", ["de", "dé", "dè"], "表示“需要、必须”时，“得”读 děi。", 3],
    ["连词成句", "哪一句把“外婆、粽子、又香又甜”说通顺了？", "外婆包的粽子又香又甜。", ["粽子外婆包的又香又甜。", "又香又甜外婆包的粽子。", "外婆又香又甜包的粽子。"], "按正常语序表达才通顺。", 3],
    ["标点符号", "“太好了，我们比赛赢了（ ）” 句末最合适填什么标点？", "感叹号", ["句号", "问号", "逗号"], "表示高兴和激动时，句末常用感叹号。", 3],
    ["课文理解", "《动物王国开大会》里，狗熊通知了很多次，主要是哪句话没说明白？", "开会时间", ["开会地点", "动物名字", "天气情况"], "通知要说清时间，大家才知道什么时候到。", 3],
    ["句子理解", "“一分钟也很重要”这句话更想告诉我们什么？", "要珍惜时间", ["要多睡一会儿", "要慢慢走路", "要把钟表藏起来"], "这句话提醒我们时间很宝贵，要珍惜。", 3],
    ["词语形式", "下面哪个词和“跑来跑去”属于同一类？", "走来走去", ["开开心心", "又香又甜", "雪白雪白"], "“走来走去”也是“来去式”词语。", 3],
    ["课文理解", "《要下雨了》里，小燕子飞得很低，主要是因为什么？", "快下雨了", ["天太冷了", "它迷路了", "它想休息"], "课文里小燕子飞得低，是因为快下雨了。", 3]
  ], "下册")
];

const gradeOneLowerStageSevenChallengeConfigs = [
  ...createGradeOneChallengeConfigs("数学", "进阶冲线", [
    ...createComputeTuples("两位数加减两位数", "+", [[25, 32], [33, 44], [52, 13], [36, 27]], 3),
    ...createComputeTuples("两位数加减两位数", "-", [[84, 52], [93, 41], [72, 26], [66, 18]], 3),
    ...createComputeTuples("100以内口算", "+", [[45, 8]], 3),
    ...createComputeTuples("100以内口算", "-", [[91, 8]], 3)
  ], "下册"),
  ...createGradeOneChallengeConfigs("语文", "进阶冲线", [
    ["音序排序", "“白、陈、胡、许”按音序排，第2个是谁？", "陈", ["白", "胡", "许"], "按音序排，白在最前，第二个是陈。", 3],
    ["多音字辨音", "“写得真好”里的“得”应该读什么？", "de", ["děi", "dé", "dāi"], "作结构助词时，“得”读 de。", 3],
    ["句子理解", "《文具的家》里的“家”主要指什么？", "文具该放回的地方", ["文具店", "同学家里", "老师办公室"], "课文提醒我们文具用完要放回固定的地方。", 3],
    ["课文理解", "《小猴子下山》最后为什么空着手回家？", "见一样爱一样", ["因为路太远", "因为没有力气", "因为下雨了"], "小猴子总是看见新的就丢掉旧的，最后什么也没留下。", 3],
    ["课文理解", "《咕咚》里，小兔一开始为什么跑起来？", "以为“咕咚”很可怕", ["想去找朋友玩", "想比赛跑步", "要去摘果子"], "小兔误以为“咕咚”是可怕的东西。", 3],
    ["传统文化", "《人之初》开头“人之初，性本善”后面一句是什么？", "性相近，习相远", ["苟不教，性乃迁", "子不学，非所宜", "玉不琢，不成器"], "《三字经》开头两句是“人之初，性本善。性相近，习相远。”", 3],
    ["连词成句", "哪一句把“放学以后、先、再”说通顺了？", "放学以后，我先写作业再看书。", ["放学以后我看书先再写作业。", "我先再看书放学以后写作业。", "写作业放学以后我再先看书。"], "按事情发生顺序和正常语序表达才通顺。", 3],
    ["标点符号", "“你愿意和我一起读书吗（ ）” 句末最合适填什么标点？", "问号", ["句号", "感叹号", "逗号"], "表示询问时，句末常用问号。", 3],
    ["课文理解", "《荷叶圆圆》里，小水珠把荷叶当成什么？", "摇篮", ["凉帽", "歌台", "停机坪"], "课文里小水珠说荷叶是自己的摇篮。", 3],
    ["词语理解", "“轻轻地”最适合形容哪种样子？", "动作很轻", ["颜色很深", "个子很高", "天气很热"], "“轻轻地”通常用来形容动作很轻。", 3]
  ], "下册")
];
...
const gradeTwoStageOneChallengeConfigs = [
  ...createChallengeConfigs("二年级", "数学", "条件上手", [
    ...
    ["时间推算", "钟面刚好指向8时，再过2小时是几时？", "10时", ["9时", "11时", "12时"], "8时再过2小时就是10时。", 1]
  ]),
...
const gradeTwoStageThreeChallengeConfigs = [
  ...
  ...createChallengeConfigs("二年级", "语文", "短文找点", [
    ...
    ["图表阅读", "教室后墙贴着值日表：周一小东扫地，周二小美擦黑板，周三小军摆桌椅。周二谁负责擦黑板？", "小美", ["小东", "小军", "老师"], "值日表中周二对应的是小美。", 2]
  ])
];

const gradeTwoStageFourChallengeConfigs = [
  ...createChallengeConfigs("二年级", "数学", "图表看懂", [
  ...
  ...createChallengeConfigs("二年级", "语文", "图表看懂", [
...
const gradeTwoLowerStageThreeChallengeConfigs = [
  ...
  ...createChallengeConfigs("二年级", "语文", "短文找点", [
    ...
    ["图表阅读", "值日表上写着：周一小青擦桌子，周二小林摆椅子，周三小红关窗。周二谁摆椅子？", "小林", ["小青", "小红", "老师"], "值日表里周二对应的是小林。", 2]
  ])
];
...
const gradeTwoLowerStageSevenChallengeConfigs = [
  ...createChallengeConfigs("二年级", "数学", "方法冲线", [
    ...
    ["长度计算", "一根84厘米的绳子，做了4个边长18厘米的正方形后，还剩多少厘米？", "12厘米", ["10厘米", "14厘米", "16厘米"], "4个边共用72厘米，84减72等于12厘米。", 3],
...
const gradeThreeStageFourChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "图文转换", [
  ...
  ...createChallengeConfigs("三年级", "语文", "图文转换", [
...
const gradeThreeStageFiveChallengeConfigs = [
  ...
  ...createChallengeConfigs("三年级", "语文", "应用连推", [
    ...
    ["通知理解", "班级公告：周三带跳绳参加比赛，周四交手工作品，周五展示读书卡。周四要交什么？", "手工作品", ["跳绳", "读书卡", "作文"], "公告里周四对应的是交手工作品。", 3],
...
const gradeThreeStageSixChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "限时稳答", [
    ...
    ["周长计算", "一个长方形长9厘米、宽4厘米，它的周长是多少厘米？", "26", createNumericDistractors(26), "周长是(9+4)×2=26厘米。", 3],
...
const gradeThreeStageSevenChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "综合冲线", [
    ...
    ["综合计算", "一根铁丝长120厘米，先做成一个边长18厘米的正方形，还剩多少厘米？", "48", createNumericDistractors(48), "正方形周长是18×4=72厘米，120-72=48厘米。", 3],
  ...
  ...createChallengeConfigs("三年级", "语文", "综合冲线", [
    ...
    ["阅读推理", "小军先把种植观察记录下来，又给植物浇水，最后把花盆搬到阳光下。浇水后他做什么？", "把花盆搬到阳光下", ["记录观察", "去操场玩", "换一个花盆"], "按顺序，浇水后的下一步是搬到阳光下。", 3],
...
const gradeThreeLowerStageOneChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "读题转弯", [
    ["面积基础", "长方形菜圃长8米，宽5米，面积是多少平方米？", "40平方米", ["35平方米", "30平方米", "45平方米"], "长方形面积用长乘宽，8乘5等于40平方米。", 1],
...
const gradeThreeLowerStageTwoChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "信息拆分", [
    ["周长计算", "一个长方形操场长9米，宽4米，它的周长是多少米？", "26", createNumericDistractors(26), "周长是(9+4)乘2，等于26米。", 1],
    ["面积计算", "一块边长6分米的正方形地砖，面积是多少平方分米？", "36", createNumericDistractors(36), "正方形面积是边长乘边长，6乘6等于36。", 1],
...
const gradeThreeLowerStageThreeChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "估算判断", [
    ...
    ["面积判断", "一块长11米、宽4米的草地，面积会超过40平方米吗？", "会", ["不会", "正好40平方米", "没法判断"], "11乘4等于44，44平方米超过40平方米。", 2],
...
const gradeThreeLowerStageFiveChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "应用连推", [
    ["两步应用", "一块长方形菜地长12米，宽5米，每平方米种3株番茄，一共能种多少株？", "180", createNumericDistractors(180), "面积是12乘5等于60平方米，再乘3，一共能种180株。", 3],
    ...
    ["两步应用", "4块边长9分米的正方形展板，一共是多少平方分米？", "324", createNumericDistractors(324), "每块面积是9乘9等于81平方分米，4块一共324平方分米。", 3],
    ...
    ["两步应用", "一块长方形布长8米，宽6米，剪去14平方米后，还剩多少平方米？", "34", createNumericDistractors(34), "布的面积是48平方米，减去14平方米后还剩34平方米。", 3],
  ...
  ...createChallengeConfigs("三年级", "语文", "应用连推", [
    ...
    ["顺序理解", "做植物标本时，先采集叶片，再夹在书里压平，最后贴在记录卡上。压平后要做什么？", "贴在记录卡上", ["先采集叶片", "去浇花", "马上装进书包"], "按步骤看，压平后的下一步是贴在记录卡上。", 3],
    ...
    ["留言理解", "留言：观察表放在科学柜第二层，放大镜在窗边，记录本在讲台上。想拿观察表应该去哪里？", "科学柜第二层", ["窗边", "讲台上", "门口柜子里"], "留言里明确写着观察表在科学柜第二层。", 3],
...
const gradeThreeLowerStageSixChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "限时稳答", [
    ...
    ["面积计算", "长方形长12厘米、宽5厘米，面积是多少平方厘米？", "60", createNumericDistractors(60), "长方形面积是12乘5，等于60平方厘米。", 3],
    ["周长计算", "一个正方形边长7厘米，周长是多少厘米？", "28", createNumericDistractors(28), "正方形周长是4个边长相加，7乘4等于28厘米。", 3],
...
const gradeThreeLowerStageSevenChallengeConfigs = [
  ...createChallengeConfigs("三年级", "数学", "综合冲线", [
    ["综合计算", "一块长方形菜地长16米，宽9米，每平方米种2株番茄，一共能种多少株？", "288", createNumericDistractors(288), "面积是16乘9等于144平方米，再乘2，一共288株。", 3],
    ...
    ["综合计算", "一块正方形空地边长15米，四周围篱笆，已经装好42米，还差多少米？", "18", createNumericDistractors(18), "正方形周长是60米，60减42还差18米。", 3],
  ...
  ...createChallengeConfigs("三年级", "语文", "综合冲线", [
    ...
    ["活动顺序", "研学时，大家先听讲解，再分组记录，最后制作模型。制作模型前要做什么？", "分组记录", ["直接回家", "先吃晚饭", "把模型拆掉"], "活动顺序里，制作模型前一步是分组记录。", 3]
  ])
];
