...
const TARGET_KNOWLEDGE_TAG = "比较判断";

function getLowerStageFourImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageFourImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第四关的带图题种子数据。");
  }
