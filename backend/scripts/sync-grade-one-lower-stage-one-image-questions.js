...
const TARGET_KNOWLEDGE_TAG = "独立看题";

function getLowerStageOneImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageOneImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第一关的带图题种子数据。");
  }
