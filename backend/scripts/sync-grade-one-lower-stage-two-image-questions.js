...
const TARGET_KNOWLEDGE_TAG = "条件配对";

function getLowerStageTwoImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageTwoImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第二关的带图题种子数据。");
  }
