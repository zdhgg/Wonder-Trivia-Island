...
const TARGET_KNOWLEDGE_TAG = "口算稳住";

function getLowerStageFiveImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageFiveImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第五关的带图题种子数据。");
  }
