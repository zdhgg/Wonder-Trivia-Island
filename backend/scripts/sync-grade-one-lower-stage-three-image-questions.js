...
const TARGET_SEMESTER = "下册";
const TARGET_KNOWLEDGE_TAG = "顺序推想";

function getLowerStageThreeImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageThreeImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第三关的带图题种子数据。");
  }
