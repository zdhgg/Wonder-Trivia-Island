...
const TARGET_KNOWLEDGE_TAG = "限时提速";

function getLowerStageSixImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageSixImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第六关的带图题种子数据。");
  }
