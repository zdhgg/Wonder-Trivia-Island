...
const TARGET_KNOWLEDGE_TAG = "数量找友";

function getStageThreeImageQuestions() {
...
function main() {
  const targetQuestions = getStageThreeImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级上册第三关的带图题种子数据。");
  }
