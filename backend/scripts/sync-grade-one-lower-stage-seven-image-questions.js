...
const TARGET_KNOWLEDGE_TAG = "进阶冲线";

function getLowerStageSevenImageQuestions() {
...
function main() {
  const targetQuestions = getLowerStageSevenImageQuestions();

  if (targetQuestions.length === 0) {
    throw new Error("未找到一年级下册第七关的带图题种子数据。");
  }
